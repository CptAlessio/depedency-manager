...
# Although it might be possible to get around this restriction by using headless browsers, 
# doing so would be unethical. The script will just return the URL, which you may manually check 
# to obtain the license details.
...
if __name__ == "__main__":
    ...
    url = get_license("org.apache.httpcomponents/httpclient")
